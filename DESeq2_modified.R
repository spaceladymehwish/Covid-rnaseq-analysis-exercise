...
setwd("D:/2nd_sem/NGS/Covid-rnaseq-analysis-exercise/Covid-rnaseq-analysis-exercise/")

#Read Metadata
metadata <- read.delim("Metadata_Covid19_Normal.tsv")

# Import the gene raw counts
counts <- read.delim("Counts_Covid19_Normal.tsv")

#Analysis

#Create DESeq2 Object
dds = DESeqDataSetFromMatrix(counts,metadata,~Disease)
...
dds$type <- relevel(dds$Disease, "normal")
...
#ggplot2
data <- plotCounts(dds, gene=topGene, intgroup=c("Disease","id"), returnData=TRUE)
